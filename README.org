...
#+BEGIN_SRC javascript
    Generic.TabType.MOVIE,   // provider has elements of type 'Generic.ItemType.MOVIE'
    Generic.TabType.TVSHOW,  // provider has elements of type 'Generic.Itemtype.TVSHOW'
    Generic.TabType.ANIME,   // will show a mix between:
                             //  - 'Generic.ItemType.MOVIE' and
                             //  - 'Generic.ItemType.TVSHOW'
#+END_SRC
...
var filters = {
    ...
    order: Generic.OrderType,   // sort order (ASC, DESC)
    sorter: Generic.SorterType, // sorter type (NAME, RATING, POPULARITY)
    limit: Number,         // number of elements to return
}
#+END_SRC

with Generic.OrderType being:
#+BEGIN_SRC javascript
    Generic.Ordertype.ASC,    // items are sorted in ascending order
    Generic.Ordertype.DESC,   // items are sorted in descending order
    Generic.OrderType.NULL    // items are not sorted
#+END_SRC

with Generic.SorterType being:
#+BEGIN_SRC javascript
    Generic.Sortertype.NAME,        // items are sorted by name
    Generic.Sortertype.RATING,      // items are sorted by rating
    Generic.Sortertype.POPULARITY,  // items are sorted by popularity
    Generic.SorterType.NULL         // items are not sorted
#+END_SRC
...
var result = {
    ...
    type: Generic.ItemType     // used by the browser to decide how to show the item
                               // (MOVIE, TVSHOW)
}
#+END_SRC

Generic.ItemType can be one of:
#+BEGIN_SRC javascript
    Generic.ItemType.MOVIE,  // item is a Movie, it has only 1 item
    Generic.ItemType.TVSHOW  // item is a TvShow, it has many elements,
