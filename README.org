...
#+BEGIN_SRC javascript
    Generic.TabType.MOVIE,   // provider has elements of type 'movie'
    Generic.TabType.TVSHOW,  // provider has elements of type 'tvshow'
    Generic.TabType.ANIME,   // will show a mix between 'movies' and 'tvshows'
#+END_SRC
